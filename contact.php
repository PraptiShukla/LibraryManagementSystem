                    ...
                    <form method="post" name="contact-us" action="contactform.php">
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary btn-shadow btn-lg" type="submit" name="submit">Send Message</button>&nbsp &nbsp &nbsp &nbsp 
                                <button class="btn btn-primary btn-shadow btn-lg" type="submit" name="display">Show Messages</button>
							</div>
                        </div>
                    </form>
                </div>
