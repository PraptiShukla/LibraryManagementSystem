...
<form action="borrowerregistration.php" method="post" autocomplete="off">
...
<a href="fees.php"><button type="submit" name="fees" style="width:200px; font-size:20px;">FEES</button></a></center>
<script>
/*function validation()
   {
...
<head></head>
<body><br>
<form action="borrowerregistration.php" method="post" autocomplete="off"><br>&nbsp &nbsp &nbsp
